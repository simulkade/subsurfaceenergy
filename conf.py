...
BLOG_AUTHOR = "Ali A. Eftekhari"  # (translatable)
BLOG_TITLE = "Subsurface Energy Storage and Extraction"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.subsurfaceenergy.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://subsurfaceenergy.com/"
BLOG_EMAIL = "e.eftekhari@gmail.com"
BLOG_DESCRIPTION = "A site that hosts my research on the topics relevant to the subsurface storage and extraction of energy"  # (translatable)
